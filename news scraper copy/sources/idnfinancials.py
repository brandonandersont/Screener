...
class IDNFinancials:
    def __init__(self):
        self.base_url = 'https://www.idnfinancials.com/id/'
    ...
    def scrape_idnfinancials(self, keywords):
        results, seen = [], set()
        for keyword in keywords:
            ...
            articles = self.soup.select("div", class_="title")
            if not articles:
...
if __name__ == "__main__":
    idnfinancials = IDNFinancials()
    keyword = input("Enter a keyword: ")  
    results = idnfinancials.scrape_idnfinancials([keyword.capitalize()])  
