...
class IDXChannel:
    ...
    def keyword_idxchannel(self, keywords):
        results, seen = [], set()
        for keyword in keywords:
            ...
            articles = self.soup.select("div", class_="list-berita-baru") 
            if not articles:
            ...
            for article in articles:
                ...
                date = article.find('div', class_='headline-date')
...
if __name__ == "__main__":
    ...
    results = idxchannel.keyword_idxchannel([keyword.capitalize()])  
