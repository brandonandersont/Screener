...
class Kontan:
    ...
    def keyword_kontan(self, keywords):
        results, seen = [], set()
        for keyword in keywords:
            ...
            articles = self.soup.select("div", class_="sp-hl linkto-black")
            if not articles:
            ...
            for article in articles:
                ...
                date = article.find('span', class_='font-gray')
...
if __name__ == "__main__":
    ...
    results = kontan.keyword_kontan([keyword.capitalize()])  
